describe('syntax parser', function () {
  ...
  it('should allow to specify custom models mapping that is used as a label as well', function () {
  ...
  it('should allow to specify custom view and models mappers', function () {
